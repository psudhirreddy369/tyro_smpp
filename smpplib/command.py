...
class SubmitSM(Command):
    ...
    params = {
        ...
        'template_id':Param(type=str,size=19),
        'pe_id':Param(type=str,size=19),        
        'telemarketing_id':Param(type=str,size=19)
    }
    ...
    params_order = (
        ...
        'ussd_service_op','template_id','pe_id','telemarketing_id'
    )
